...
class BodegaIvisApp:
    def __init__(self):
        ...
        self.inicializar_bd()
        self.ven.withdraw()  # Ocultamos la ventana principal inicialmente
        self.mostrar_login()
    ...
    def mostrar_login(self):
        ...
        self.login_win.configure(bg="#34495e")
    ...
    def mostrar_menu_principal(self):
        ...
        self.menu_win.config(bg="#2c3e50")
        self.menu_win.protocol("WM_DELETE_WINDOW", self.cerrar_aplicacion)
        
        self.title_frame = Frame(self.menu_win, bg="#34495e", width=1000, height=80)
        ...
        self.btn_cerrar_sesion = Button(self.menu_win, text="Cerrar Sesión", font=("Arial", 12, "bold"),
                                     bg="#95a5a6", fg="black", command=self.cerrar_sesion,
                                     cursor="hand2", width=18, height=2)
    ...
    def mostrar_crud(self, tabla):
        ...
        self.crud_win.configure(bg="#2c3e50")
        self.crud_win.grab_set()
        
        self.tabla_actual = tabla
        
        self.title_frame = Frame(self.crud_win, bg="#34495e", width=1000, height=60)
        self.title_frame.place(x=0, y=0)
    ...
    def ventana_formulario(self, accion, valores=None):
        ...
        self.form_win.configure(bg="#2c3e50")
        ...
        for i, (label, campo) in enumerate(campos):
            ...
            entry = Entry(self.form_win, font=("Arial", 10), width=25)
        ...
        self.btn_guardar = Button(self.form_win, text="Guardar", bg="#27ae60", fg="black",
                               font=("Arial", 10, "bold"), command=lambda: self.guardar_registro(accion, self.form_win),
                               cursor="hand2", width=12)
        self.btn_guardar.place(x=120, y=400)
        
        self.btn_cancelar = Button(self.form_win, text="Cancelar", bg="#e74c3c", fg="black",
    ...
    def mostrar_reportes(self):
        ...
        self.reportes_win.configure(bg="#2c3e50")
        self.reportes_win.grab_set()
        
        self.title_frame = Frame(self.reportes_win, bg="#34495e", width=1000, height=60)
        self.title_frame.place(x=0, y=0)
        ...
        self.btn_rep_clientes = Button(self.reportes_win, text="Reporte de Clientes", bg="#3498db", fg="black",
                                    font=("Arial", 12, "bold"), command=lambda: self.generar_reporte("Clientes"),
                                    cursor="hand2", width=20, height=2)
        self.btn_rep_clientes.place(x=500, y=150, anchor="center")
        
        self.btn_rep_ventas = Button(self.reportes_win, text="Reporte de Ventas", bg="#2ecc71", fg="black",
                                  font=("Arial", 12, "bold"), command=lambda: self.generar_reporte("Venta"),
                                  cursor="hand2", width=20, height=2)
        self.btn_rep_ventas.place(x=500, y=220, anchor="center")
        
        self.btn_rep_general = Button(self.reportes_win, text="Reporte General", bg="#9b59b6", fg="black",
                                   font=("Arial", 12, "bold"), command=self.reporte_general,
                                   cursor="hand2", width=20, height=2)
        self.btn_rep_general.place(x=500, y=290, anchor="center")
        
        self.btn_volver_reportes = Button(self.reportes_win, text="Volver al Menú", bg="#95a5a6", fg="black",
                                       font=("Arial", 12, "bold"), command=self.reportes_win.destroy,
                                       cursor="hand2", width=20, height=2)
        self.btn_volver_reportes.place(x=500, y=380, anchor="center")
    ...
    def generar_reporte(self, tabla):
        ...
        self.reporte_win.configure(bg="#2c3e50")
        ...
        self.tree_frame = Frame(self.reporte_win, bg="#2c3e50")
        ...
        tree = ttk.Treeview(self.tree_frame, columns=columnas, show="headings")
        ...
        self.btn_imprimir = Button(self.reporte_win, text="Preparar para Impresión", bg="#e74c3c", fg="black",
...
"""
            ...
            self.text_widget = Text(self.impresion_win, wrap=WORD, font=("Courier", 10))
    ...
    def reporte_general(self):
        ...
        self.rep_general_win.configure(bg="#2c3e50")
        ...
        self.stats_frame = Frame(self.rep_general_win, bg="#34495e", width=540, height=350)
        ...
        self.btn_volver_reporte = Button(self.rep_general_win, text="Volver", bg="#95a5a6", fg="black",
    ...
    def mostrar_info_empresa(self):
        ...
        self.info_empresa_win.configure(bg="#2c3e50")
        self.info_empresa_win.grab_set()
        
        self.title_frame = Frame(self.info_empresa_win, bg="#34495e", width=1000, height=80)
        self.title_frame.place(x=0, y=0)
        ...
        self.content_frame = Frame(self.info_empresa_win, bg="#34495e", width=940, height=500)
        ...
        self.btn_volver_empresa = Button(self.info_empresa_win, text="Volver al Menú", bg="#95a5a6", fg="black",
    ...
    def mostrar_info_equipo(self):
        ...
        self.info_equipo_win.geometry("1000x800")  # Aumentamos la altura de la ventana
        self.info_equipo_win.configure(bg="#2c3e50")
        self.info_equipo_win.grab_set()
        
        self.title_frame = Frame(self.info_equipo_win, bg="#34495e", width=1000, height=80)
        self.title_frame.place(x=0, y=0)
        ...
        self.container = Frame(self.info_equipo_win, bg="#2c3e50")
        self.container.place(x=0, y=80, width=1000, height=650)
        
        self.canvas = Canvas(self.container, bg="#2c3e50", highlightthickness=0)
        self.scrollbar = ttk.Scrollbar(self.container, orient="vertical", command=self.canvas.yview)
        self.scrollable_frame = Frame(self.canvas, bg="#2c3e50")
        ...
        self.content_frame = Frame(self.scrollable_frame, bg="#34495e", width=940, height=1200)
        ...
        for i, miembro in enumerate(miembros, 1):
            self.member_frame = Frame(self.content_frame, bg="#2c3e50", width=880, height=120)
        ...
        self.btn_volver_equipo = Button(self.info_equipo_win, text="Volver al Menú", bg="#95a5a6", fg="black",
